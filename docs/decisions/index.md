...
| 날짜 | 제목 | 상태 | 관련 회의 |
|---|---|---|---|
| 2026-07-15 | [노션-코드 불일치 해소 — 현재 구현을 최종 스펙으로 채택](2026-07-15-current-implementation-as-spec.md) | decided | - |
| 2026-07-22 | [세션 설정 수정 & 자동종료 정책 도입](2026-07-22-session-settings-and-lifecycle.md) | decided | [2026-07-22](../meetings/2026-07-22/synthesis.md) |
