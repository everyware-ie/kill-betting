...
public class Rule {
    ...
    public int calculateScore(boolean isChicken, long failedTop10Count, boolean allTeamMembersFailedTop10) {
        ...
        if (isType(RuleType.TEAM_SURVIVAL_PENALTY) && allTeamMembersFailedTop10) {
            return -value;
        }
        return 0;
    }
