      ...
      <div style={{ marginBottom: 16 }}>
        ...
        <input
          ...
          style={{
            ...
            background: '#1a1800',
            border: `1px solid ${
              email.length > 0 && emailValid  ? 'rgba(76,175,80,0.6)'  :
              email.length > 0 && !emailValid ? 'rgba(229,57,53,0.6)'  :
              'rgba(200,155,0,0.3)'
            }`,
            color: '#E8DFC0',
            padding: '9px 12px',
        ...
        {email.length > 0 && !emailValid && (
          <div style={{ marginTop: 5, fontSize: 11, color: '#E53935' }}>⚠ 올바른 이메일 형식을 입력해주세요</div>
        )}
      </div>
